...
namespace engine {
	namespace asset {
		...
		void Mesh::upload(std::vector<glm::vec3> vertices, std::vector<glm::vec3> normals, std::vector<glm::vec2> uv2D, std::vector<uint32_t> indices)
		{
		...
		void Mesh::upload(std::vector<glm::vec3> vertices, std::vector<glm::vec3> normals, std::vector<glm::vec3> uv3D, std::vector<uint32_t> indices)
		{
			this->vertices = std::move(vertices);
			this->normals = std::move(normals);
